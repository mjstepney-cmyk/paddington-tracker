    ...
    while True:
        try:
            r = requests.get(
                ...
                params={"numRows": 30, "timeWindow": 120},
                timeout=15,
            )
            r.raise_for_status()
            data = r.json()
            ...
            for s in raw:
                ...
                svcs.append({
                    ...
                    "headcode": s.get("trainid","") or s.get("uid",""),
            ...
            with lock: state["darwin_error"] = str(e)
